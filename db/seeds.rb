...
seed_photo = URI.open('http://coffeeguymike.com/abandonya/IMGP7184.JPG')
seed_house.photo.attach(io: file, filename: 'stairs.jpg', content_type: 'image/jpg')
seed_house.save
...
mikes_house.photo.attach(io: file, filename: 'kinu.jpg', content_type: 'image/jpg')
mikes_house.save!
...
maries_house.photo.attach(io: file, filename: 'octo.jpg', content_type: 'image/jpg')
maries_house.save!

hamishs_house = House.new(name: "hamish's apartment with like one mattress on the floor", address: '455 straya mate', haunted: 5, user_id: hamish.id)
hamishs_photo = URI.open('http://coffeeguymike.com/abandonya/stiltsWeirdCurve.jpg')
hamishs_house.photo.attach(io: file, filename: 'stilts.jpg', content_type: 'image/jpg')
hamishs_house.save!
...
ellies_house.photo.attach(io: file, filename: 'noge.jpg', content_type: 'image/jpg')
ellies_house.save!
