...
seed_house.photo.attach(io: file, filename: '', content_type: 'image/jpg')
seed_house.save
...
mikes_house.photo.attach(io: file, filename: '', content_type: 'image/jpg')
mikes_house.save!
...
maries_house.photo.attach(io: file, filename: '', content_type: 'image/jpg')
maries_house.save!
...
hamishs_house.photo.attach(io: file, filename: '', content_type: 'image/jpg')
hamishs_house.save!
...
ellies_house.photo.attach(io: file, filename: '', content_type: 'image/jpg')
ellies_house.save!
